...
- Name: survey-flow.spec.ts >> Survey end-to-end flow >> should load surveys and navigate to answer a public survey
- Location: tests\e2e\survey-flow.spec.ts:4:7
...
Expected: visible
Error: strict mode violation: locator('text=Pesquisas') resolved to 3 elements:
    ...
    3) <td colspan="4" class="px-4 align-middle py-10 text-center font-medium text-zinc-500">Carregando pesquisas…</td> aka getByRole('cell', { name: 'Carregando pesquisas…' })
